...
(function() {
  var data = {
    'zh-CN': {
      ...
      'hero.name': '你的名字',
      'hero.scroll': '向下滚动',
      'hero.typing': '开发者 / 创造者 / 探索者',
      'about.title': '/ 关于我',
      'about.p1': '在这里写一段关于你的介绍，聊聊你的背景、兴趣，或者你在做什么。',
      'about.p2': '这里是第二段，可以写得更具体一些，比如你的经历、技术方向、或者你的理念。',
      'skills.title': '/ 技能',
      'gallery.title': '/ 影像',
      'projects.title': '/ 项目',
    ...
    'en': {
      ...
      'hero.name': 'Your Name',
      'hero.scroll': 'SCROLL',
      'hero.typing': 'Developer / Creator / Explorer',
      'about.title': '/ About',
      'about.p1': 'Write something about yourself here. Talk about your background, interests, or what you are working on.',
      'about.p2': 'A second paragraph with more details — your experience, technical focus, or your philosophy.',
      'skills.title': '/ Skills',
